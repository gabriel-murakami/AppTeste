...
class MemesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create meme" do
    assert_difference('Meme.count') do
      post memes_url, params: { meme: { category: @meme.category, description: @meme.description, link: @meme.link, title: @meme.title } }
    end
  ...
  test "should update meme" do
    patch meme_url(@meme), params: { meme: { category: @meme.category, description: @meme.description, link: @meme.link, title: @meme.title } }
